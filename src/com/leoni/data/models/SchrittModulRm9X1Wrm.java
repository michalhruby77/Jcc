...
@Entity
public class SchrittModulRm9X1Wrm implements Comparable{
    @Id
   ...
   /* public Color getColor() {
    ...
    public int compareTo(Object o) {
        SchrittModulRm9X1Wrm schritt = (SchrittModulRm9X1Wrm) o;

        int i = assLevelSeq.compareTo(schritt.assLevelSeq);
        if (i != 0) return i;

        i = moduls.getSachNrBest().compareTo(schritt.moduls.getSachNrBest());
        return i;
    }
}
