...
public interface SchrittModulRm9X1WrmManager extends GenericManager<SchrittModulRm9X1Wrm> {
    ...
    public SchrittModulRm9X1Wrm addNewSchritt(Moduls moduls, String variante1, String variante2, String variante3, String variante4,
                                              String seite, String schritt, String popis, String farba, String isCheck,
                                              String bandName, String user, Integer assLevelSeq);
