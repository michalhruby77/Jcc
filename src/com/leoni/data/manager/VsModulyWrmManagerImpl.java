...
System.out.println(item.getId());
                System.out.println("moduls    " + item.getModuls());

                bw.write(
                        item.getModuls().getSachNrBest()+
                        ";"+item.getModuls().getSachNrLieferant()+";"+
                        item.getModuls().getProdGruppe()+";"+
                        item.getModuls().getAusfuehrung()+";"+
                        item.getVodic()+";"+
                        item.getPrierez()+";"+
                        item.getVs().getNazov()+"\n"
                );
