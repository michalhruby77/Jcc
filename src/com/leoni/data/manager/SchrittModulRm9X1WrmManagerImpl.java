...
public class SchrittModulRm9X1WrmManagerImpl   extends GenericManagerImpl<SchrittModulRm9X1Wrm> implements SchrittModulRm9X1WrmManager{
    ...
    public SchrittModulRm9X1Wrm addNewSchritt(Moduls moduls, String variante1, String variante2, String variante3,
                                              String variante4, String seite, String schritt, String popis, String farba,
                                              String isCheck, String bandName, String user, Integer assLevelSeq) {
        ...
        newSchritt.setAssLevelSeq(assLevelSeq);
    ...
    public List<SchrittModulRm9X1Wrm> findBy(String id, String sachNrLieferantSearch, String sachNrBestSearch, String ausfuehrungSearch, String prodGruppeSearch, String bandNameSearch, String seiteSearch, String schrittSearch) {
        ...
        if(!schrittSearch.equals("")){caList.add(new Equal("schritt", schrittSearch.trim()));}
