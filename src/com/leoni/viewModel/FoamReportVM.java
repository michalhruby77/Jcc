...
public class FoamReportVM {
    ...
    {   if(timeFrom!=null&&timeTo!=null){
        ...
        File xslFile = prodNrLogManager.exportToFile(prodNrMap,persNr, dateString, timeFrom,timeTo);
        ...
        AMedia amedia = new AMedia(persNr+"_"+dateString+"_"+timeFrom+"_"+timeTo+".csv", "csv", "application/file", is);
