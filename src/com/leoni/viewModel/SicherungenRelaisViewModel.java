...
public class SicherungenRelaisViewModel{
    ...
    @Command
    @NotifyChange ({"relaisList","platzListSearch","selectedRelay"})
    public void search()
    ...
    @Command
    @NotifyChange ({"relaisList","id","sachNrLieferantSearch","sachNrBestSearch","ausfuehrungSearch","prodGruppeSearch",
            "boxSearch","platzSearch","wertSearch","selectedRelay"})
