...
public class FindHarnessVM {
    ...
    private boolean globalVis = false;
                ...
                new EventListener() {
                    public void onEvent(Event evt) {
                        if ("onYes".equals(evt.getName())) {
                            ...
                            harnessLpab62.setStaClipZones(null);
                            lpab62Manager.saveOrUpdate(harnessLpab62);
    ...
    public void updateT1(){
        if (harnessLpab62.isStaTuelleT1()) harnessLpab62.setStaTuelleT1(false);
        else harnessLpab62.setStaTuelleT1(true);
        lpab62Manager.saveOrUpdate(harnessLpab62);
        prodNrLogManager.saveProdNrLog(harnessLpab62.getProdNr(),harnessLpab62.getKabelsatzKz(),"jcc",userName,"TUELLE T1","STA TUELLE T1 CHANGED");
        harnessLpab62 = lpab62Manager.findByProdnrAndKabelsatz(tempProdNr,tempKabelsatz).get(0);
    }
    ...
    public void updateT2(){
        if (harnessLpab62.isStaTuelleT2()) harnessLpab62.setStaTuelleT2(false);
        else harnessLpab62.setStaTuelleT2(true);
        lpab62Manager.saveOrUpdate(harnessLpab62);
        prodNrLogManager.saveProdNrLog(harnessLpab62.getProdNr(),harnessLpab62.getKabelsatzKz(),"jcc",userName,"TUELLE T2","STA TUELLE T2 CHANGED");
        harnessLpab62 = lpab62Manager.findByProdnrAndKabelsatz(tempProdNr,tempKabelsatz).get(0);
    }
    ...
    public void updateT3(){
        if (harnessLpab62.isStaTuelleT3()) harnessLpab62.setStaTuelleT3(false);
        else harnessLpab62.setStaTuelleT3(true);
        lpab62Manager.saveOrUpdate(harnessLpab62);
        prodNrLogManager.saveProdNrLog(harnessLpab62.getProdNr(),harnessLpab62.getKabelsatzKz(),"jcc",userName,"TUELLE T3","STA TUELLE T3 CHANGED");
        harnessLpab62 = lpab62Manager.findByProdnrAndKabelsatz(tempProdNr,tempKabelsatz).get(0);
    }
    ...
    public void updateT4(){
        if (harnessLpab62.isStaTuelleT4()) harnessLpab62.setStaTuelleT4(false);
        else harnessLpab62.setStaTuelleT4(true);
        lpab62Manager.saveOrUpdate(harnessLpab62);
        prodNrLogManager.saveProdNrLog(harnessLpab62.getProdNr(),harnessLpab62.getKabelsatzKz(),"jcc",userName,"TUELLE T4","STA TUELLE T4 CHANGED");
        harnessLpab62 = lpab62Manager.findByProdnrAndKabelsatz(tempProdNr,tempKabelsatz).get(0);
    }

    @Command
    @NotifyChange ({"harnessLpab62"})
    public void updateT5(){
        if (harnessLpab62.isStaTuelleT5()) harnessLpab62.setStaTuelleT5(false);
        else harnessLpab62.setStaTuelleT5(true);
        lpab62Manager.saveOrUpdate(harnessLpab62);
        prodNrLogManager.saveProdNrLog(harnessLpab62.getProdNr(),harnessLpab62.getKabelsatzKz(),"jcc",userName,"TUELLE T5","STA TUELLE T5 CHANGED");
        harnessLpab62 = lpab62Manager.findByProdnrAndKabelsatz(tempProdNr,tempKabelsatz).get(0);
    }
    ...
    public boolean isGlobalVis() {
        return globalVis;
    }

    public void setGlobalVis(boolean globalVis) {
        this.globalVis = globalVis;
    }
}
