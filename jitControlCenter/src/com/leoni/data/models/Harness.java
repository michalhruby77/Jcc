...
@Entity
@Table(name = "band")
public class Harness implements Comparable{
    @Id
    ...
    public int getSide_b_step() {
        return side_b_step;
    }

    public void setSide_b_step(int side_b_step) {
        this.side_b_step = side_b_step;
    }
    public int getSide_a_step() {
        return side_a_step;
    }

    public void setSide_a_step(int side_a_step) {
