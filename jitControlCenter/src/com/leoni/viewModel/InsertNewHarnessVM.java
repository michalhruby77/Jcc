...
public class InsertNewHarnessVM {
    ...
    {
     if (prodNr!=null&&customer!=null&&prodGruppe!=null&&ausfuehrung!=null&&lieferDatum!=null&&reihenfNr!=null){
     ...
     int rowsAdded62 = lpab62Manager.addHarness(prodNr,customer.getNumber(),prodGruppe,ausfuehrung,lieferDatumInt,reihenfNr);
     System.out.println("pocet pridanych riadkov do lpab62: " + rowsAdded62);
     int rowsAdded64 = lpab64Manager.addrecords(modulsList,prodNr);
        ...
        for (CustomRow item : customRowList){
            ...
            if(item.getSelectedModul()!=null) {
                ...
                if(selectedModul.getKabelsatzKz()!=null&&selectedModul.getKabelsatzKz().equals("F")){
                    ...
                    if(groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).size()==1){
                        ProdGroup prodGroup = groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).get(0);
                ...
                if(selectedModul.getKabelsatzKz()!=null&&selectedModul.getKabelsatzKz().equals("C")){
                    ...
                    if(groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).size()==1){
                        ProdGroup prodGroup = groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).get(0);
                        if(prodGroup.getKabelsatzKz().trim().equals("C")){grundF++;}
                    }
                }
                if(selectedModul.getKabelsatzKz()!=null&&selectedModul.getKabelsatzKz().equals("T")){
                    ...
                    if(groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).size()==1){
                        ProdGroup prodGroup = groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).get(0);
                        if(prodGroup.getKabelsatzKz().trim().equals("T")){grundF++;}
                    }
                }
                if(selectedModul.getKabelsatzKz()!=null&&selectedModul.getKabelsatzKz().equals("U")){
                    ...
                    if(groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).size()==1){
                        ProdGroup prodGroup = groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).get(0);
                        if(prodGroup.getKabelsatzKz().trim().equals("U")){grundF++;}
                    }
                }
                if(selectedModul.getKabelsatzKz()!=null&&selectedModul.getKabelsatzKz().equals("E")){
                    ...
                    if(groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).size()==1){
                        ProdGroup prodGroup = groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).get(0);
                        if(prodGroup.getKabelsatzKz().trim().equals("E")){grundF++;}
                    }
                }
                if(selectedModul.getKabelsatzKz()!=null&&selectedModul.getKabelsatzKz().equals("R")){
                    ...
                    if(groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).size()==1){
                        ProdGroup prodGroup = groupDeriveManager.deriveProdGroup(selectedModul.getSachNrBest().trim()).get(0);
                        if(prodGroup.getKabelsatzKz().trim().equals("R")){grundF++;}
                    }
                }
            }
        }
